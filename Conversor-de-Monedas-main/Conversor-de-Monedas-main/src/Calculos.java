...
public class Calculos {
    ...
    public void almacenarValores(String monedaBase, String monedaObjetivo){
        ...
        this.monedaFinal = monedaObjetivo;
    ...
    public String obtenerMensajeRespuesta() {
        String mensaje = getMonedaBase().toUpperCase() + " " + getCantidad() + " equivale a: " + getMonedaFinal().toUpperCase() + " " + conversion.buscaConversion(getMonedaBase(), getMonedaFinal(), getCantidad());
